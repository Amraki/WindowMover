...
#include <WinAPI.au3>
#include <Window Mover Gui.au3> ; External Gui file created by ISN AutoIt Studio (http://www.isnetwork.at/)

Global $ScriptName = StringTrimRight(@ScriptName, 4) ; Get script name without extension
Global $iniFile = StringTrimRight(@ScriptFullPath, 4) & " Config.ini" ; Name config file
